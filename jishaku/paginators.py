...
class DynamicButton(ui.Button[V_co]):
    ...
    def __init__(
        self,
        callback: typing.Callable[[disnake.Interaction], typing.Coroutine[typing.Any, typing.Any, typing.Any]],
...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes, too-many-public-methods
    ...
    def __init__(
        ...
        **kwargs: typing.Any
        ...
        self.button_start: DynamicButton[typing.Self] = DynamicButton(
            self.button_start_callback, self.button_start_label, style=disnake.ButtonStyle.secondary
        )
        self.button_previous: DynamicButton[typing.Self] = DynamicButton(
            self.button_previous_callback, self.button_previous_label, style=disnake.ButtonStyle.secondary
        )
        self.button_current: DynamicButton[typing.Self] = DynamicButton(
            self.button_current_callback, self.button_current_label, style=disnake.ButtonStyle.primary
        )
        self.button_next: DynamicButton[typing.Self] = DynamicButton(
            self.button_next_callback, self.button_next_label, style=disnake.ButtonStyle.secondary
        )
        self.button_last: DynamicButton[typing.Self] = DynamicButton(
            self.button_last_callback, self.button_last_label, style=disnake.ButtonStyle.secondary
        )
        self.button_goto: DynamicButton[typing.Self] = DynamicButton(
            self.button_goto_callback, self.button_goto_label, style=disnake.ButtonStyle.primary
        )
        self.button_close: DynamicButton[typing.Self] = DynamicButton(
            self.button_close_callback, self.button_close_label, style=disnake.ButtonStyle.danger
        )
    ...
    async def button_start_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_previous_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_current_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_next_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_last_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    class PageChangeModal(ui.Modal, title="Go to page"):
        ...
        page_number: ui.TextInput[ui.Modal] = ui.TextInput(label="Page number", style=disnake.TextStyle.short)
    ...
    async def button_goto_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_close_callback(self, interaction: disnake.Interaction):  # pylint: disable=unused-argument
